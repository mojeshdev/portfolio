...
const Card = () => {
    return (
    <div className="w-full flex justify-center mt-20 sm:mt-32 px-4">
    <div className="relative bg-black w-[300px] sm:w-[350px] group transition-all duration-700 aspect-video flex items-center justify-center">
        ...
        <p className="px-10 text-[10px] sm:text-[12px] text-gray-700 text-center">
            It’s so nice that you had the time to view this page
        </p>
        <p className="font-serif text-[10px] sm:text-[12px] text-gray-700 text-center">
            Wishing you a fantastic day ahead!
        </p>
        <p className="font-sans text-[10px] text-gray-700 pt-5">MOJESHDEV</p>
        </div>

        {/* Seal Button */}
        <button
        className="seal bg-rose-500 text-red-800 w-10 aspect-square rounded-full z-40 text-[10px] flex items-center
        justify-center font-semibold [clip-path:polygon(50%_0%,_80%_10%,_100%_35%,_100%_70%,_80%_90%,_50%_100%,_20%_90%,_0%_70%,_0%_35%,_20%_10%)]
